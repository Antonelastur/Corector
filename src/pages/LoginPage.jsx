        ...
        <div className="login-page">
            <div className="login-card">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '16px 0', opacity: 0.5 }}>
                    <div style={{ flex: 1, height: '1px', background: 'var(--gray-300, #ccc)' }} />
                    <span style={{ fontSize: '0.8rem', color: 'var(--gray-400, #999)' }}>sau</span>
                    <div style={{ flex: 1, height: '1px', background: 'var(--gray-300, #ccc)' }} />
                </div>

                <button className="btn btn-primary btn-lg w-full" onClick={handleGuestLogin} style={{ padding: '14px 32px', fontSize: '1rem', width: '100%' }}>
